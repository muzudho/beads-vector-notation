...
def convert_text_to_element_list(text):
    ...
    if q:
        ...
        # print(f"c:{text[p+1:]}")
        new_element_list.append(convert_text_to_element_list(text[:q]))
        new_element_list.append(convert_text_to_element_list(text[q+1:p]))
        new_element_list.append(convert_text_to_element_list(text[p+1:]))
